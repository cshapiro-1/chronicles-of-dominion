...
def build_100_percent_mesopotamian_campaign():
    ...
    # -------------------------------------------------------------
    # Calibrated camera transform: High elevation looking down diagonally across the river valley
    ...
    print("==================================================================")
    print("   100% VISUAL MATCH CAMPAIGN MAP ASSEMBLED AND SAVED CLEANLY!    ")
    print("==================================================================")
